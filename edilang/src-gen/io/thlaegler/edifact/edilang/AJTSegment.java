 ...
 * </p>
 * <ul>
 *   <li>{@link io.thlaegler.edifact.edilang.AJTSegment#getTodo <em>Todo</em>}</li>
 * </ul>
 *
...
public interface AJTSegment extends AbstractEdiSegment
{
   ...
   * @see #setTodo(String)
   * @see io.thlaegler.edifact.edilang.EdilangPackage#getAJTSegment_Todo()
   * @model
   * @generated
   */
  String getTodo();
  ...
  /**
   * Sets the value of the '{@link io.thlaegler.edifact.edilang.AJTSegment#getTodo <em>Todo</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
