 ...
 * </p>
 * <ul>
 *   <li>{@link io.thlaegler.edifact.edilang.CDVSegment#getTodo <em>Todo</em>}</li>
 * </ul>
 *
...
public interface CDVSegment extends AbstractEdiSegment
{
   ...
   * @see #setTodo(String)
   * @see io.thlaegler.edifact.edilang.EdilangPackage#getCDVSegment_Todo()
   * @model
   * @generated
   */
  String getTodo();
  ...
  /**
   * Sets the value of the '{@link io.thlaegler.edifact.edilang.CDVSegment#getTodo <em>Todo</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
