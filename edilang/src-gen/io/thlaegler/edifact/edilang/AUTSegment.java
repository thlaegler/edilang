 ...
 * </p>
 * <ul>
 *   <li>{@link io.thlaegler.edifact.edilang.AUTSegment#getTodo <em>Todo</em>}</li>
 * </ul>
 *
...
public interface AUTSegment extends AbstractEdiSegment
{
   ...
   * @see #setTodo(String)
   * @see io.thlaegler.edifact.edilang.EdilangPackage#getAUTSegment_Todo()
   * @model
   * @generated
   */
  String getTodo();
  ...
  /**
   * Sets the value of the '{@link io.thlaegler.edifact.edilang.AUTSegment#getTodo <em>Todo</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
